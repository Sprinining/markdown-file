    ...
    int largestRectangleArea(vector<int> &heights) {
        ...
        for (int i = 0; i < heights.size(); i++) {
            ...
            while (!stk.empty() && heights[i] < heights[stk.top()]) {
                ...
                int w = i - stk.top() - 1;
                int h = heights[mid];
/*                cout << "left: heigths[" << mid << "] = " << heights[mid] <<
                     "\tright: heigths[" << i << "] = " << heights[i] <<
                     "\tarea=" << w * h << endl;*/
...
int main() {
    vector<int> ary = {2, 1, 3, 4, 2, 3};
    Solution solution;
    solution.largestRectangleArea(ary);
/*    left: heigths[1] = 2	right: heigths[2] = 1	area=2
    left: heigths[4] = 4	right: heigths[5] = 2	area=4
    left: heigths[3] = 3	right: heigths[5] = 2	area=6
    left: heigths[6] = 3	right: heigths[7] = 0	area=3
    left: heigths[5] = 2	right: heigths[7] = 0	area=8
    left: heigths[2] = 1	right: heigths[7] = 0	area=6*/
}
```
